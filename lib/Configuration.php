...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.deposco.com/latest';
     ...
     * @var string
     */
    protected $userAgent = 'BeLenkaAPI/{packageVersion}/PHP';
    ...
    {
        $report  = 'PHP SDK (BeLenka\Deposco) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.0.2519' . PHP_EOL;
