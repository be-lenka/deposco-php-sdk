...
/**
 * BaseShipmentLineDTOLineSerialNumbersInner Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class BaseShipmentLineDTOLineSerialNumbersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseShipmentLineDTO_lineSerialNumbers_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['serial_number']) && (mb_strlen($this->container['serial_number']) > 200)) {
            $invalidProperties[] = "invalid value for 'serial_number', the character length must be smaller than or equal to 200.";
        }
    ...
    public function setSerialNumber($serial_number)
    {
        ...
        if ((mb_strlen($serial_number) > 200)) {
            throw new \InvalidArgumentException('invalid length for $serial_number when calling BaseShipmentLineDTOLineSerialNumbersInner., must be smaller than or equal to 200.');
        }
