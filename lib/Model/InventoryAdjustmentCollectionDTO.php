...
/**
 * InventoryAdjustmentCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class InventoryAdjustmentCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InventoryAdjustmentCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\InventoryAdjustmentDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling InventoryAdjustmentCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\InventoryAdjustmentDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\InventoryAdjustmentDTO[]|null $data data
     *
     * @return self
     */
