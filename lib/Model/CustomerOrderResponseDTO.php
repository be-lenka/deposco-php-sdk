...
/**
 * CustomerOrderResponseDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerOrderResponseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerOrderResponseDTO';
    ...
    protected static $openAPITypes = [
        'customer_order' => '\BeLenka\Deposco\Model\CustomerOrderResponseDTOCustomerOrder',
        'notices' => '\BeLenka\Deposco\Model\CustomerOrderNoticeDTO[]'
    ];
    ...
    */
     ...
     * Gets customer_order
     *
     * @return \BeLenka\Deposco\Model\CustomerOrderResponseDTOCustomerOrder|null
     */
     ...
     * Sets customer_order
     *
     * @param \BeLenka\Deposco\Model\CustomerOrderResponseDTOCustomerOrder|null $customer_order customer_order
     *
     * @return self
     */
     ...
     * Gets notices
     *
     * @return \BeLenka\Deposco\Model\CustomerOrderNoticeDTO[]|null
     */
     ...
     * Sets notices
     *
     * @param \BeLenka\Deposco\Model\CustomerOrderNoticeDTO[]|null $notices Array of notices for the customer order.
     *
     * @return self
     */
    ...
    {
        if (is_null($notices)) {
            array_push($this->openAPINullablesSetToNull, 'notices');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('notices', $nullablesSetToNull);
            if ($index !== FALSE) {
