...
/**
 * InboundTransferOrderLineDTOAllOf Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class InboundTransferOrderLineDTOAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InboundTransferOrderLineDTO_allOf';
    ...
    */
    ...
    public function setInboundLpn($inbound_lpn)
    {
        ...
        if (!is_null($inbound_lpn) && (mb_strlen($inbound_lpn) > 30)) {
            throw new \InvalidArgumentException('invalid length for $inbound_lpn when calling InboundTransferOrderLineDTOAllOf., must be smaller than or equal to 30.');
        }
    ...
    public function setMasterInboundLpn($master_inbound_lpn)
    {
        ...
        if (!is_null($master_inbound_lpn) && (mb_strlen($master_inbound_lpn) > 30)) {
            throw new \InvalidArgumentException('invalid length for $master_inbound_lpn when calling InboundTransferOrderLineDTOAllOf., must be smaller than or equal to 30.');
        }
