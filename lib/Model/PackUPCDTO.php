 ...
 */
class PackUPCDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackUPCDTO';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling PackUPCDTO., must conform to the pattern /.*\\S.*/.");
        }
