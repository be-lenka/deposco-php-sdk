...
/**
 * CustomerOrderLineCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerOrderLineCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerOrderLineCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\CustomerOrderLineDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling CustomerOrderLineCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\CustomerOrderLineDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\CustomerOrderLineDTO[]|null $data data
     *
     * @return self
     */
