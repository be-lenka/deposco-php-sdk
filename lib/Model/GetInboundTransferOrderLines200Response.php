<?php
/**
 * GetInboundTransferOrderLines200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetInboundTransferOrderLines200Response Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class GetInboundTransferOrderLines200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getInboundTransferOrderLines_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\InboundTransferOrderLineCollectionDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling GetInboundTransferOrderLines200Response., must be bigger than or equal to 1.');
        }
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\InboundTransferOrderLineCollectionDTO[]|null $data data
     *
     * @return self
     */
