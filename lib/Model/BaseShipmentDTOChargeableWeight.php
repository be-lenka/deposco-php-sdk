<?php
/**
 * BaseShipmentDTOChargeableWeight
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * BaseShipmentDTOChargeableWeight Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseShipmentDTOChargeableWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseShipmentDTO_chargeableWeight';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value > 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling BaseShipmentDTOChargeableWeight., must be smaller than or equal to 10000000.');
        }
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling BaseShipmentDTOChargeableWeight., must be bigger than or equal to 0.');
        }
