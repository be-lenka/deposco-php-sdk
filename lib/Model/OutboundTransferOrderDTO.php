...
/**
 * OutboundTransferOrderDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class OutboundTransferOrderDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutboundTransferOrderDTO';
    ...
    protected static $openAPITypes = [
        ...
        'order_lines' => '\BeLenka\Deposco\Model\OutboundTransferOrderLineCollectionDTO',
        'carrier_special_services' => '\BeLenka\Deposco\Model\CarrierSpecialServiceDTO[]',
        'shipments' => '\BeLenka\Deposco\Model\OutboundTransferOrderDTOAllOfShipments'
    ];
    ...
    public const TYPE_OUTBOUND_TRANSFER_ORDER = 'Outbound Transfer Order';
    ...
    {
        return [
            self::TYPE_OUTBOUND_TRANSFER_ORDER,
            self::TYPE_NULL,
        ];
    }
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $number when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($number)))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling OutboundTransferOrderDTO., must conform to the pattern /.*\\S.*/.");
        }
    ...
    public function setOrderPriority($order_priority)
    {
        ...
        if (($order_priority > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $order_priority when calling OutboundTransferOrderDTO., must be smaller than or equal to 2147483647.');
        }
        if (($order_priority < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $order_priority when calling OutboundTransferOrderDTO., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setOrderSummary($order_summary)
    {
        ...
        if ((mb_strlen($order_summary) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $order_summary when calling OutboundTransferOrderDTO., must be smaller than or equal to 1000.');
        }
    ...
    public function setOrderSource($order_source)
    {
        ...
        if ((mb_strlen($order_source) > 100)) {
            throw new \InvalidArgumentException('invalid length for $order_source when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setSecondaryOrderSource($secondary_order_source)
    {
        ...
        if ((mb_strlen($secondary_order_source) > 100)) {
            throw new \InvalidArgumentException('invalid length for $secondary_order_source when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomerOrderNumber($customer_order_number)
    {
        ...
        if ((mb_strlen($customer_order_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $customer_order_number when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setRelatedOrderNumber($related_order_number)
    {
        ...
        if ((mb_strlen($related_order_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $related_order_number when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setPartnerInvoiceNumber($partner_invoice_number)
    {
        ...
        if ((mb_strlen($partner_invoice_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $partner_invoice_number when calling OutboundTransferOrderDTO., must be smaller than or equal to 20.');
        }
    ...
    public function setBillToAccountNumber($bill_to_account_number)
    {
        ...
        if ((mb_strlen($bill_to_account_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $bill_to_account_number when calling OutboundTransferOrderDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setShipVia($ship_via)
    {
        ...
        if ((mb_strlen($ship_via) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ship_via when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setShipVendor($ship_vendor)
    {
        ...
        if ((mb_strlen($ship_vendor) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ship_vendor when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setShipMethod($ship_method)
    {
        ...
        if ((mb_strlen($ship_method) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ship_method when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setFreightTermsType($freight_terms_type)
    {
        ...
        if ((mb_strlen($freight_terms_type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $freight_terms_type when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setFreightBillToAccount($freight_bill_to_account)
    {
        ...
        if ((mb_strlen($freight_bill_to_account) > 50)) {
            throw new \InvalidArgumentException('invalid length for $freight_bill_to_account when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setReturnShipVia($return_ship_via)
    {
        ...
        if ((mb_strlen($return_ship_via) > 100)) {
            throw new \InvalidArgumentException('invalid length for $return_ship_via when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setReturnShipOption($return_ship_option)
    {
        ...
        if ((mb_strlen($return_ship_option) > 10)) {
            throw new \InvalidArgumentException('invalid length for $return_ship_option when calling OutboundTransferOrderDTO., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryConfirmation($delivery_confirmation)
    {
        ...
        if ((mb_strlen($delivery_confirmation) > 45)) {
            throw new \InvalidArgumentException('invalid length for $delivery_confirmation when calling OutboundTransferOrderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setHubId($hub_id)
    {
        ...
        if ((mb_strlen($hub_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $hub_id when calling OutboundTransferOrderDTO., must be smaller than or equal to 10.');
        }
    ...
    public function setRoutingNumber($routing_number)
    {
        ...
        if ((mb_strlen($routing_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling OutboundTransferOrderDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setIncotermsType($incoterms_type)
    {
        ...
        if ((mb_strlen($incoterms_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_type when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setImportType($import_type)
    {
        ...
        if ((mb_strlen($import_type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $import_type when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setImportReference($import_reference)
    {
        ...
        if ((mb_strlen($import_reference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $import_reference when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setExportReference($export_reference)
    {
        ...
        if ((mb_strlen($export_reference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $export_reference when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setOtherReferenceNumber($other_reference_number)
    {
        ...
        if ((mb_strlen($other_reference_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $other_reference_number when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setOtherReferenceNumber2($other_reference_number2)
    {
        ...
        if ((mb_strlen($other_reference_number2) > 45)) {
            throw new \InvalidArgumentException('invalid length for $other_reference_number2 when calling OutboundTransferOrderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setEntryName($entry_name)
    {
        ...
        if ((mb_strlen($entry_name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $entry_name when calling OutboundTransferOrderDTO., must be smaller than or equal to 200.');
        }
    ...
    public function setEntryPhone1($entry_phone1)
    {
        ...
        if ((mb_strlen($entry_phone1) > 30)) {
            throw new \InvalidArgumentException('invalid length for $entry_phone1 when calling OutboundTransferOrderDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setSaleConditionCode($sale_condition_code)
    {
        ...
        if ((mb_strlen($sale_condition_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sale_condition_code when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setSeller($seller)
    {
        ...
        if ((mb_strlen($seller) > 50)) {
            throw new \InvalidArgumentException('invalid length for $seller when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setNotificationCode1($notification_code1)
    {
        ...
        if ((mb_strlen($notification_code1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $notification_code1 when calling OutboundTransferOrderDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setNotificationCode2($notification_code2)
    {
        ...
        if ((mb_strlen($notification_code2) > 5)) {
            throw new \InvalidArgumentException('invalid length for $notification_code2 when calling OutboundTransferOrderDTO., must be smaller than or equal to 5.');
        }
    ...
    public function setNotificationCode3($notification_code3)
    {
        ...
        if ((mb_strlen($notification_code3) > 5)) {
            throw new \InvalidArgumentException('invalid length for $notification_code3 when calling OutboundTransferOrderDTO., must be smaller than or equal to 5.');
        }
    ...
    public function setVerbalConfirmationName($verbal_confirmation_name)
    {
        ...
        if ((mb_strlen($verbal_confirmation_name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $verbal_confirmation_name when calling OutboundTransferOrderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setVerbalConfirmationPhoneNumber($verbal_confirmation_phone_number)
    {
        ...
        if ((mb_strlen($verbal_confirmation_phone_number) > 45)) {
            throw new \InvalidArgumentException('invalid length for $verbal_confirmation_phone_number when calling OutboundTransferOrderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setCustomAttribute1($custom_attribute1)
    {
        ...
        if ((mb_strlen($custom_attribute1) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute1 when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute2($custom_attribute2)
    {
        ...
        if ((mb_strlen($custom_attribute2) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute2 when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute3($custom_attribute3)
    {
        ...
        if ((mb_strlen($custom_attribute3) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute3 when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute4($custom_attribute4)
    {
        ...
        if ((mb_strlen($custom_attribute4) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute4 when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute5($custom_attribute5)
    {
        ...
        if ((mb_strlen($custom_attribute5) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute5 when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute6($custom_attribute6)
    {
        ...
        if ((mb_strlen($custom_attribute6) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute6 when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute7($custom_attribute7)
    {
        ...
        if ((mb_strlen($custom_attribute7) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute7 when calling OutboundTransferOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setDutyPaidByContactName($duty_paid_by_contact_name)
    {
        ...
        if (!is_null($duty_paid_by_contact_name) && (mb_strlen($duty_paid_by_contact_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $duty_paid_by_contact_name when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setDutyPaidByAccount($duty_paid_by_account)
    {
        ...
        if (!is_null($duty_paid_by_account) && (mb_strlen($duty_paid_by_account) > 50)) {
            throw new \InvalidArgumentException('invalid length for $duty_paid_by_account when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setDutyPaidByPostalCode($duty_paid_by_postal_code)
    {
        ...
        if (!is_null($duty_paid_by_postal_code) && (mb_strlen($duty_paid_by_postal_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $duty_paid_by_postal_code when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setDutyPaidByCountry($duty_paid_by_country)
    {
        ...
        if (!is_null($duty_paid_by_country) && (mb_strlen($duty_paid_by_country) > 50)) {
            throw new \InvalidArgumentException('invalid length for $duty_paid_by_country when calling OutboundTransferOrderDTO., must be smaller than or equal to 50.');
        }
     ...
     *
     * @param \BeLenka\Deposco\Model\EntityRef[]|null $customer_order_headers Array of customer orders (from Bright Order) that are associated with the outbound transfer order.
     *
     * @return self
     */
     ...
     * Gets order_lines
     *
     * @return \BeLenka\Deposco\Model\OutboundTransferOrderLineCollectionDTO|null
     */
     ...
     * Sets order_lines
     *
     * @param \BeLenka\Deposco\Model\OutboundTransferOrderLineCollectionDTO|null $order_lines order_lines
     *
     * @return self
     */
     ...
     *
     * @param \BeLenka\Deposco\Model\CarrierSpecialServiceDTO[]|null $carrier_special_services Array of carrier special service records for the order.
     *
     * @return self
     */
     ...
     * Gets shipments
     *
     * @return \BeLenka\Deposco\Model\OutboundTransferOrderDTOAllOfShipments|null
     */
     ...
     * Sets shipments
     *
     * @param \BeLenka\Deposco\Model\OutboundTransferOrderDTOAllOfShipments|null $shipments shipments
     *
     * @return self
     */
