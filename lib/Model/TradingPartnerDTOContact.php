...
/**
 * TradingPartnerDTOContact Class Doc Comment
 *
 * @category Class
 ...
 */
class TradingPartnerDTOContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TradingPartnerDTO_contact';
    ...
    */
     ...
     * Sets first_name
     *
     * @param string|null $first_name First name of the contact person.
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TradingPartnerDTOContact., must be smaller than or equal to 30.');
        }
     ...
     * Sets last_name
     *
     * @param string|null $last_name Last name of the contact person.
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling TradingPartnerDTOContact., must be smaller than or equal to 30.');
        }
     ...
     * Sets email
     *
     * @param string|null $email Email address of the contact person.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email when calling TradingPartnerDTOContact., must be smaller than or equal to 50.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone Phone number of the contact person.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (mb_strlen($phone) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling TradingPartnerDTOContact., must be smaller than or equal to 30.');
        }
     ...
     * Sets fax
     *
     * @param string|null $fax Fax number of the contact person.
     *
     * @return self
     */
    public function setFax($fax)
    {
        ...
        if (!is_null($fax) && (mb_strlen($fax) > 20)) {
            throw new \InvalidArgumentException('invalid length for $fax when calling TradingPartnerDTOContact., must be smaller than or equal to 20.');
        }
