...
/**
 * CustomerOrderDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerOrderDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerOrderDTO';
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $number when calling CustomerOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setOrderSummary($order_summary)
    {
        ...
        if (!is_null($order_summary) && (mb_strlen($order_summary) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $order_summary when calling CustomerOrderDTO., must be smaller than or equal to 1000.');
        }
    ...
    public function setOrderSource($order_source)
    {
        ...
        if (!is_null($order_source) && (mb_strlen($order_source) > 100)) {
            throw new \InvalidArgumentException('invalid length for $order_source when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setSecondaryOrderSource($secondary_order_source)
    {
        ...
        if (!is_null($secondary_order_source) && (mb_strlen($secondary_order_source) > 100)) {
            throw new \InvalidArgumentException('invalid length for $secondary_order_source when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setExternalOrderNumber($external_order_number)
    {
        ...
        if ((mb_strlen($external_order_number) > 150)) {
            throw new \InvalidArgumentException('invalid length for $external_order_number when calling CustomerOrderDTO., must be smaller than or equal to 150.');
        }
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($external_order_number)))) {
            throw new \InvalidArgumentException("invalid value for \$external_order_number when calling CustomerOrderDTO., must conform to the pattern /.*\\S.*/.");
        }
    ...
    public function setRelatedOrderNumber($related_order_number)
    {
        ...
        if (!is_null($related_order_number) && (mb_strlen($related_order_number) > 256)) {
            throw new \InvalidArgumentException('invalid length for $related_order_number when calling CustomerOrderDTO., must be smaller than or equal to 256.');
        }
    ...
    public function setContractNumber($contract_number)
    {
        ...
        if (!is_null($contract_number) && (mb_strlen($contract_number) > 150)) {
            throw new \InvalidArgumentException('invalid length for $contract_number when calling CustomerOrderDTO., must be smaller than or equal to 150.');
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if (!is_null($account_number) && (mb_strlen($account_number) > 256)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling CustomerOrderDTO., must be smaller than or equal to 256.');
        }
    ...
    public function setFreightBillToAccount($freight_bill_to_account)
    {
        ...
        if (!is_null($freight_bill_to_account) && (mb_strlen($freight_bill_to_account) > 50)) {
            throw new \InvalidArgumentException('invalid length for $freight_bill_to_account when calling CustomerOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setTotal($total)
    {
        ...
        if (($total > 0)) {
            throw new \InvalidArgumentException('invalid value for $total when calling CustomerOrderDTO., must be smaller than or equal to 10000000.');
        }
        if (($total < 0)) {
            throw new \InvalidArgumentException('invalid value for $total when calling CustomerOrderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setSubTotal($sub_total)
    {
        ...
        if (($sub_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $sub_total when calling CustomerOrderDTO., must be smaller than or equal to 10000000.');
        }
        if (($sub_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $sub_total when calling CustomerOrderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setDiscountSubtotal($discount_subtotal)
    {
        ...
        if (($discount_subtotal > 0)) {
            throw new \InvalidArgumentException('invalid value for $discount_subtotal when calling CustomerOrderDTO., must be smaller than or equal to 10000000.');
        }
        if (($discount_subtotal < 0)) {
            throw new \InvalidArgumentException('invalid value for $discount_subtotal when calling CustomerOrderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setShippingTotal($shipping_total)
    {
        ...
        if (($shipping_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_total when calling CustomerOrderDTO., must be smaller than or equal to 10000000.');
        }
        if (($shipping_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_total when calling CustomerOrderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setShippingAmount($shipping_amount)
    {
        ...
        if (($shipping_amount > 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_amount when calling CustomerOrderDTO., must be smaller than or equal to 10000000.');
        }
        if (($shipping_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_amount when calling CustomerOrderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxTotal($tax_total)
    {
        ...
        if (($tax_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_total when calling CustomerOrderDTO., must be smaller than or equal to 10000000.');
        }
        if (($tax_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_total when calling CustomerOrderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxableTotal($taxable_total)
    {
        ...
        if (($taxable_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $taxable_total when calling CustomerOrderDTO., must be smaller than or equal to 10000000.');
        }
        if (($taxable_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $taxable_total when calling CustomerOrderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setUntaxableTotal($untaxable_total)
    {
        ...
        if (($untaxable_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $untaxable_total when calling CustomerOrderDTO., must be smaller than or equal to 10000000.');
        }
        if (($untaxable_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $untaxable_total when calling CustomerOrderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setShipTaxTotal($ship_tax_total)
    {
        ...
        if (($ship_tax_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $ship_tax_total when calling CustomerOrderDTO., must be smaller than or equal to 10000000.');
        }
        if (($ship_tax_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $ship_tax_total when calling CustomerOrderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setInsuranceTotal($insurance_total)
    {
        ...
        if (($insurance_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $insurance_total when calling CustomerOrderDTO., must be smaller than or equal to 10000000.');
        }
        if (($insurance_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $insurance_total when calling CustomerOrderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if (!is_null($currency_code) && (mb_strlen($currency_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CustomerOrderDTO., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentStatus($payment_status)
    {
        ...
        if (!is_null($payment_status) && (mb_strlen($payment_status) > 30)) {
            throw new \InvalidArgumentException('invalid length for $payment_status when calling CustomerOrderDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setShipVia($ship_via)
    {
        ...
        if (!is_null($ship_via) && (mb_strlen($ship_via) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ship_via when calling CustomerOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setShipVendor($ship_vendor)
    {
        ...
        if (!is_null($ship_vendor) && (mb_strlen($ship_vendor) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ship_vendor when calling CustomerOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setReturnShipVia($return_ship_via)
    {
        ...
        if (!is_null($return_ship_via) && (mb_strlen($return_ship_via) > 50)) {
            throw new \InvalidArgumentException('invalid length for $return_ship_via when calling CustomerOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setReturnShipOption($return_ship_option)
    {
        ...
        if (!is_null($return_ship_option) && (mb_strlen($return_ship_option) > 100)) {
            throw new \InvalidArgumentException('invalid length for $return_ship_option when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setDeliveryConfirmation($delivery_confirmation)
    {
        ...
        if (!is_null($delivery_confirmation) && (mb_strlen($delivery_confirmation) > 45)) {
            throw new \InvalidArgumentException('invalid length for $delivery_confirmation when calling CustomerOrderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setScacCode($scac_code)
    {
        ...
        if (!is_null($scac_code) && (mb_strlen($scac_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $scac_code when calling CustomerOrderDTO., must be smaller than or equal to 10.');
        }
    ...
    public function setTransMethodCode($trans_method_code)
    {
        ...
        if (!is_null($trans_method_code) && (mb_strlen($trans_method_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $trans_method_code when calling CustomerOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setRoutingNumber($routing_number)
    {
        ...
        if (!is_null($routing_number) && (mb_strlen($routing_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling CustomerOrderDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setDutyPaidBy($duty_paid_by)
    {
        ...
        if (!is_null($duty_paid_by) && (mb_strlen($duty_paid_by) > 20)) {
            throw new \InvalidArgumentException('invalid length for $duty_paid_by when calling CustomerOrderDTO., must be smaller than or equal to 20.');
        }
    ...
    public function setImportType($import_type)
    {
        ...
        if (!is_null($import_type) && (mb_strlen($import_type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $import_type when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setOtherReferenceNumber($other_reference_number)
    {
        ...
        if (!is_null($other_reference_number) && (mb_strlen($other_reference_number) > 256)) {
            throw new \InvalidArgumentException('invalid length for $other_reference_number when calling CustomerOrderDTO., must be smaller than or equal to 256.');
        }
    ...
    public function setOtherReferenceNumber2($other_reference_number2)
    {
        ...
        if (!is_null($other_reference_number2) && (mb_strlen($other_reference_number2) > 256)) {
            throw new \InvalidArgumentException('invalid length for $other_reference_number2 when calling CustomerOrderDTO., must be smaller than or equal to 256.');
        }
    ...
    public function setConsolidationGroupKey($consolidation_group_key)
    {
        ...
        if (!is_null($consolidation_group_key) && (mb_strlen($consolidation_group_key) > 40)) {
            throw new \InvalidArgumentException('invalid length for $consolidation_group_key when calling CustomerOrderDTO., must be smaller than or equal to 40.');
        }
    ...
    public function setSaleConditionCode($sale_condition_code)
    {
        ...
        if (!is_null($sale_condition_code) && (mb_strlen($sale_condition_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sale_condition_code when calling CustomerOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setDepartment($department)
    {
        ...
        if (!is_null($department) && (mb_strlen($department) > 50)) {
            throw new \InvalidArgumentException('invalid length for $department when calling CustomerOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setDivision($division)
    {
        ...
        if (!is_null($division) && (mb_strlen($division) > 50)) {
            throw new \InvalidArgumentException('invalid length for $division when calling CustomerOrderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setVerbalConfirmationName($verbal_confirmation_name)
    {
        ...
        if (!is_null($verbal_confirmation_name) && (mb_strlen($verbal_confirmation_name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $verbal_confirmation_name when calling CustomerOrderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setVerbalConfirmationPhoneNumber($verbal_confirmation_phone_number)
    {
        ...
        if (!is_null($verbal_confirmation_phone_number) && (mb_strlen($verbal_confirmation_phone_number) > 45)) {
            throw new \InvalidArgumentException('invalid length for $verbal_confirmation_phone_number when calling CustomerOrderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setCustomAttribute1($custom_attribute1)
    {
        ...
        if (!is_null($custom_attribute1) && (mb_strlen($custom_attribute1) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute1 when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute2($custom_attribute2)
    {
        ...
        if (!is_null($custom_attribute2) && (mb_strlen($custom_attribute2) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute2 when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute3($custom_attribute3)
    {
        ...
        if (!is_null($custom_attribute3) && (mb_strlen($custom_attribute3) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute3 when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute4($custom_attribute4)
    {
        ...
        if (!is_null($custom_attribute4) && (mb_strlen($custom_attribute4) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute4 when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute5($custom_attribute5)
    {
        ...
        if (!is_null($custom_attribute5) && (mb_strlen($custom_attribute5) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute5 when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute6($custom_attribute6)
    {
        ...
        if (!is_null($custom_attribute6) && (mb_strlen($custom_attribute6) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute6 when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute7($custom_attribute7)
    {
        ...
        if (!is_null($custom_attribute7) && (mb_strlen($custom_attribute7) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute7 when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute8($custom_attribute8)
    {
        ...
        if (!is_null($custom_attribute8) && (mb_strlen($custom_attribute8) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute8 when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute9($custom_attribute9)
    {
        ...
        if (!is_null($custom_attribute9) && (mb_strlen($custom_attribute9) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute9 when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute10($custom_attribute10)
    {
        ...
        if (!is_null($custom_attribute10) && (mb_strlen($custom_attribute10) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute10 when calling CustomerOrderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCheckoutPromiseRef($checkout_promise_ref)
    {
        ...
        if (!is_null($checkout_promise_ref) && (mb_strlen($checkout_promise_ref) > 60)) {
            throw new \InvalidArgumentException('invalid length for $checkout_promise_ref when calling CustomerOrderDTO., must be smaller than or equal to 60.');
        }
