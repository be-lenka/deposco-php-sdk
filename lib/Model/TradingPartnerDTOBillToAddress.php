...
/**
 * TradingPartnerDTOBillToAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class TradingPartnerDTOBillToAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TradingPartnerDTO_billToAddress';
    ...
    */
     ...
     * Sets line1
     *
     * @param string|null $line1 First line of the billing address for the trading partner.
     *
     * @return self
     */
    public function setLine1($line1)
    {
        ...
        if (!is_null($line1) && (mb_strlen($line1) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling TradingPartnerDTOBillToAddress., must be smaller than or equal to 64.');
        }
     ...
     * Sets line2
     *
     * @param string|null $line2 Second line of the billing address for the trading partner.
     *
     * @return self
     */
    public function setLine2($line2)
    {
        ...
        if (!is_null($line2) && (mb_strlen($line2) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling TradingPartnerDTOBillToAddress., must be smaller than or equal to 64.');
        }
     ...
     * Sets line3
     *
     * @param string|null $line3 Third line of the billing address for the trading partner.
     *
     * @return self
     */
    public function setLine3($line3)
    {
        ...
        if (!is_null($line3) && (mb_strlen($line3) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line3 when calling TradingPartnerDTOBillToAddress., must be smaller than or equal to 64.');
        }
     ...
     * Sets line4
     *
     * @param string|null $line4 Fourth line of the billing address for the trading partner.
     *
     * @return self
     */
    public function setLine4($line4)
    {
        ...
        if (!is_null($line4) && (mb_strlen($line4) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line4 when calling TradingPartnerDTOBillToAddress., must be smaller than or equal to 64.');
        }
     ...
     * Sets city
     *
     * @param string|null $city City for the billing address for the trading partner.
     *
     * @return self
     */
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling TradingPartnerDTOBillToAddress., must be smaller than or equal to 30.');
        }
     ...
     * Sets state_province
     *
     * @param string|null $state_province State or province for the billing address for the trading partner.
     *
     * @return self
     */
    public function setStateProvince($state_province)
    {
        ...
        if (!is_null($state_province) && (mb_strlen($state_province) > 100)) {
            throw new \InvalidArgumentException('invalid length for $state_province when calling TradingPartnerDTOBillToAddress., must be smaller than or equal to 100.');
        }
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Postal code for the billing address for the trading partner.
     *
     * @return self
     */
    public function setPostalCode($postal_code)
    {
        ...
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling TradingPartnerDTOBillToAddress., must be smaller than or equal to 20.');
        }
     ...
     * Sets country
     *
     * @param string|null $country Two-letter (ISO 3166-1 alpha-2) country code for the country in the billing address for the trading partner.
     *
     * @return self
     */
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling TradingPartnerDTOBillToAddress., must be smaller than or equal to 2.');
        }
