<?php
/**
 * BillableTransactionDTOItemAttributes
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * BillableTransactionDTOItemAttributes Class Doc Comment
 *
 * @category Class
 ...
 */
class BillableTransactionDTOItemAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillableTransactionDTO_itemAttributes';
    ...
    */
     ...
     * Sets lot_number
     *
     * @param string|null $lot_number Lot number for the item that is associated with the billable transaction.
     *
     * @return self
     */
    public function setLotNumber($lot_number)
    {
        ...
        if ((mb_strlen($lot_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $lot_number when calling BillableTransactionDTOItemAttributes., must be smaller than or equal to 50.');
        }
     ...
     * Sets serial_number
     *
     * @param string|null $serial_number Serial number for the item that is associated with the billable transaction.
     *
     * @return self
     */
    public function setSerialNumber($serial_number)
    {
        ...
        if ((mb_strlen($serial_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $serial_number when calling BillableTransactionDTOItemAttributes., must be smaller than or equal to 50.');
        }
     ...
     * Sets born_on_date
     *
     * @param \DateTime|null $born_on_date Born on date for the item that is associated with the billable transaction.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $expiration_date Expiration date for the item that is associated with the billable transaction.
     *
     * @return self
     */
