...
/**
 * BaseOrderHeaderDTOWeight Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseOrderHeaderDTOWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseOrderHeaderDTO_weight';
    ...
    */
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight > 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling BaseOrderHeaderDTOWeight., must be smaller than or equal to 10000000.');
        }
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling BaseOrderHeaderDTOWeight., must be bigger than or equal to 0.');
        }
