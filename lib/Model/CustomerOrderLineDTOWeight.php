...
/**
 * CustomerOrderLineDTOWeight Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerOrderLineDTOWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerOrderLineDTO_weight';
    ...
    */
     ...
     * Sets weight
     *
     * @param int|null $weight Numeric value for the weight.
     *
     * @return self
     */
    public function setWeight($weight)
    {
        ...
        if (($weight > 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling CustomerOrderLineDTOWeight., must be smaller than or equal to 10000000.');
        }
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling CustomerOrderLineDTOWeight., must be bigger than or equal to 0.');
        }
