<?php
/**
 * InventoryUpdateDTOExistingInventory
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * InventoryUpdateDTOExistingInventory Class Doc Comment
 *
 * @category Class
 ...
 */
class InventoryUpdateDTOExistingInventory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InventoryUpdateDTO_existingInventory';
    ...
    */
     ...
     * Sets serial_number
     *
     * @param string|null $serial_number Serial number of the existing inventory record for the item.
     *
     * @return self
     */
    public function setSerialNumber($serial_number)
    {
        ...
        if (!is_null($serial_number) && (mb_strlen($serial_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $serial_number when calling InventoryUpdateDTOExistingInventory., must be smaller than or equal to 50.');
        }
     ...
     * Sets lot_number
     *
     * @param string|null $lot_number Lot number of the existing inventory record for the item.
     *
     * @return self
     */
    public function setLotNumber($lot_number)
    {
        ...
        if (!is_null($lot_number) && (mb_strlen($lot_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $lot_number when calling InventoryUpdateDTOExistingInventory., must be smaller than or equal to 50.');
        }
     ...
     *
     * @param \DateTime|null $expiration_date Expiration date of the existing inventory record for the item.
     *
     * @return self
     */
     ...
     *
     * @param string|null $inventory_condition Condition of the existing inventory record for the item.
     *
     * @return self
     */
    public function setInventoryCondition($inventory_condition)
    {
        ...
        if (!is_null($inventory_condition) && (mb_strlen($inventory_condition) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_condition when calling InventoryUpdateDTOExistingInventory., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string|null $inventory_attribute1 Additional inventory attribute for the existing inventory record for the item.
     *
     * @return self
     */
    public function setInventoryAttribute1($inventory_attribute1)
    {
        ...
        if (!is_null($inventory_attribute1) && (mb_strlen($inventory_attribute1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_attribute1 when calling InventoryUpdateDTOExistingInventory., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string|null $inventory_attribute2 Additional inventory attribute for the existing inventory record for the item.
     *
     * @return self
     */
    public function setInventoryAttribute2($inventory_attribute2)
    {
        ...
        if (!is_null($inventory_attribute2) && (mb_strlen($inventory_attribute2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_attribute2 when calling InventoryUpdateDTOExistingInventory., must be smaller than or equal to 255.');
        }
