...
/**
 * AddressContactDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class AddressContactDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddressContactDTO';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email when calling AddressContactDTO., must be smaller than or equal to 50.');
        }
