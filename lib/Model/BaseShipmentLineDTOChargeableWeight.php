...
/**
 * BaseShipmentLineDTOChargeableWeight Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseShipmentLineDTOChargeableWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseShipmentLineDTO_chargeableWeight';
    ...
    */
     ...
     * Sets value
     *
     * @param int $value Numeric value for the weight.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if (($value > 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling BaseShipmentLineDTOChargeableWeight., must be smaller than or equal to 10000000.');
        }
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling BaseShipmentLineDTOChargeableWeight., must be bigger than or equal to 0.');
        }
