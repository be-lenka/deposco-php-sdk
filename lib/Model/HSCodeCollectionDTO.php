...
/**
 * HSCodeCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class HSCodeCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HSCodeCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\HSCodeDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling HSCodeCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\HSCodeDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\HSCodeDTO[]|null $data data
     *
     * @return self
     */
