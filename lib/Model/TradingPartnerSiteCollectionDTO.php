...
/**
 * TradingPartnerSiteCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class TradingPartnerSiteCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TradingPartnerSiteCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\TradingPartnerSiteDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling TradingPartnerSiteCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\TradingPartnerSiteDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\TradingPartnerSiteDTO[]|null $data data
     *
     * @return self
     */
