...
/**
 * BaseOrderHeaderDTO Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class BaseOrderHeaderDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseOrderHeaderDTO';
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $number when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($number)))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling BaseOrderHeaderDTO., must conform to the pattern /.*\\S.*/.");
        }
    ...
    public function setOrderPriority($order_priority)
    {
        ...
        if (($order_priority > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $order_priority when calling BaseOrderHeaderDTO., must be smaller than or equal to 2147483647.');
        }
        if (($order_priority < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $order_priority when calling BaseOrderHeaderDTO., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setOrderSummary($order_summary)
    {
        ...
        if ((mb_strlen($order_summary) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $order_summary when calling BaseOrderHeaderDTO., must be smaller than or equal to 1000.');
        }
    ...
    public function setOrderSource($order_source)
    {
        ...
        if ((mb_strlen($order_source) > 100)) {
            throw new \InvalidArgumentException('invalid length for $order_source when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setSecondaryOrderSource($secondary_order_source)
    {
        ...
        if ((mb_strlen($secondary_order_source) > 100)) {
            throw new \InvalidArgumentException('invalid length for $secondary_order_source when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomerOrderNumber($customer_order_number)
    {
        ...
        if ((mb_strlen($customer_order_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $customer_order_number when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setRelatedOrderNumber($related_order_number)
    {
        ...
        if ((mb_strlen($related_order_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $related_order_number when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setPartnerInvoiceNumber($partner_invoice_number)
    {
        ...
        if ((mb_strlen($partner_invoice_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $partner_invoice_number when calling BaseOrderHeaderDTO., must be smaller than or equal to 20.');
        }
    ...
    public function setBillToAccountNumber($bill_to_account_number)
    {
        ...
        if ((mb_strlen($bill_to_account_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $bill_to_account_number when calling BaseOrderHeaderDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setOrderTotal($order_total)
    {
        ...
        if (($order_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_total when calling BaseOrderHeaderDTO., must be smaller than or equal to 10000000.');
        }
        if (($order_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_total when calling BaseOrderHeaderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderSubtotal($order_subtotal)
    {
        ...
        if (($order_subtotal > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_subtotal when calling BaseOrderHeaderDTO., must be smaller than or equal to 10000000.');
        }
        if (($order_subtotal < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_subtotal when calling BaseOrderHeaderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderDiscountSubtotal($order_discount_subtotal)
    {
        ...
        if (($order_discount_subtotal > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_discount_subtotal when calling BaseOrderHeaderDTO., must be smaller than or equal to 10000000.');
        }
        if (($order_discount_subtotal < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_discount_subtotal when calling BaseOrderHeaderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderShippingTotal($order_shipping_total)
    {
        ...
        if (($order_shipping_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_shipping_total when calling BaseOrderHeaderDTO., must be smaller than or equal to 10000000.');
        }
        if (($order_shipping_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_shipping_total when calling BaseOrderHeaderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderShipTotal($order_ship_total)
    {
        ...
        if (($order_ship_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_ship_total when calling BaseOrderHeaderDTO., must be smaller than or equal to 10000000.');
        }
        if (($order_ship_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_ship_total when calling BaseOrderHeaderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderTaxTotal($order_tax_total)
    {
        ...
        if (($order_tax_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_tax_total when calling BaseOrderHeaderDTO., must be smaller than or equal to 10000000.');
        }
        if (($order_tax_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_tax_total when calling BaseOrderHeaderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderTaxableTotal($order_taxable_total)
    {
        ...
        if (($order_taxable_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_taxable_total when calling BaseOrderHeaderDTO., must be smaller than or equal to 10000000.');
        }
        if (($order_taxable_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_taxable_total when calling BaseOrderHeaderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderUntaxableTotal($order_untaxable_total)
    {
        ...
        if (($order_untaxable_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_untaxable_total when calling BaseOrderHeaderDTO., must be smaller than or equal to 10000000.');
        }
        if (($order_untaxable_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_untaxable_total when calling BaseOrderHeaderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setShippingTaxTotal($shipping_tax_total)
    {
        ...
        if (($shipping_tax_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_tax_total when calling BaseOrderHeaderDTO., must be smaller than or equal to 10000000.');
        }
        if (($shipping_tax_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_tax_total when calling BaseOrderHeaderDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setShipVia($ship_via)
    {
        ...
        if ((mb_strlen($ship_via) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ship_via when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setShipVendor($ship_vendor)
    {
        ...
        if ((mb_strlen($ship_vendor) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ship_vendor when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setShipMethod($ship_method)
    {
        ...
        if ((mb_strlen($ship_method) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ship_method when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setFreightTermsType($freight_terms_type)
    {
        ...
        if ((mb_strlen($freight_terms_type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $freight_terms_type when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setFreightBillToAccount($freight_bill_to_account)
    {
        ...
        if ((mb_strlen($freight_bill_to_account) > 50)) {
            throw new \InvalidArgumentException('invalid length for $freight_bill_to_account when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setReturnShipVia($return_ship_via)
    {
        ...
        if ((mb_strlen($return_ship_via) > 100)) {
            throw new \InvalidArgumentException('invalid length for $return_ship_via when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setReturnShipOption($return_ship_option)
    {
        ...
        if ((mb_strlen($return_ship_option) > 10)) {
            throw new \InvalidArgumentException('invalid length for $return_ship_option when calling BaseOrderHeaderDTO., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryConfirmation($delivery_confirmation)
    {
        ...
        if ((mb_strlen($delivery_confirmation) > 45)) {
            throw new \InvalidArgumentException('invalid length for $delivery_confirmation when calling BaseOrderHeaderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setHubId($hub_id)
    {
        ...
        if ((mb_strlen($hub_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $hub_id when calling BaseOrderHeaderDTO., must be smaller than or equal to 10.');
        }
    ...
    public function setRoutingNumber($routing_number)
    {
        ...
        if ((mb_strlen($routing_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling BaseOrderHeaderDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setIncotermsType($incoterms_type)
    {
        ...
        if ((mb_strlen($incoterms_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_type when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setImportType($import_type)
    {
        ...
        if ((mb_strlen($import_type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $import_type when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setImportReference($import_reference)
    {
        ...
        if ((mb_strlen($import_reference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $import_reference when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setExportReference($export_reference)
    {
        ...
        if ((mb_strlen($export_reference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $export_reference when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setOtherReferenceNumber($other_reference_number)
    {
        ...
        if ((mb_strlen($other_reference_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $other_reference_number when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setOtherReferenceNumber2($other_reference_number2)
    {
        ...
        if ((mb_strlen($other_reference_number2) > 45)) {
            throw new \InvalidArgumentException('invalid length for $other_reference_number2 when calling BaseOrderHeaderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setEntryName($entry_name)
    {
        ...
        if ((mb_strlen($entry_name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $entry_name when calling BaseOrderHeaderDTO., must be smaller than or equal to 200.');
        }
    ...
    public function setEntryPhone1($entry_phone1)
    {
        ...
        if ((mb_strlen($entry_phone1) > 30)) {
            throw new \InvalidArgumentException('invalid length for $entry_phone1 when calling BaseOrderHeaderDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setSaleConditionCode($sale_condition_code)
    {
        ...
        if ((mb_strlen($sale_condition_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sale_condition_code when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setSeller($seller)
    {
        ...
        if ((mb_strlen($seller) > 50)) {
            throw new \InvalidArgumentException('invalid length for $seller when calling BaseOrderHeaderDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setNotificationCode1($notification_code1)
    {
        ...
        if ((mb_strlen($notification_code1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $notification_code1 when calling BaseOrderHeaderDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setNotificationCode2($notification_code2)
    {
        ...
        if ((mb_strlen($notification_code2) > 5)) {
            throw new \InvalidArgumentException('invalid length for $notification_code2 when calling BaseOrderHeaderDTO., must be smaller than or equal to 5.');
        }
    ...
    public function setNotificationCode3($notification_code3)
    {
        ...
        if ((mb_strlen($notification_code3) > 5)) {
            throw new \InvalidArgumentException('invalid length for $notification_code3 when calling BaseOrderHeaderDTO., must be smaller than or equal to 5.');
        }
    ...
    public function setVerbalConfirmationName($verbal_confirmation_name)
    {
        ...
        if ((mb_strlen($verbal_confirmation_name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $verbal_confirmation_name when calling BaseOrderHeaderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setVerbalConfirmationPhoneNumber($verbal_confirmation_phone_number)
    {
        ...
        if ((mb_strlen($verbal_confirmation_phone_number) > 45)) {
            throw new \InvalidArgumentException('invalid length for $verbal_confirmation_phone_number when calling BaseOrderHeaderDTO., must be smaller than or equal to 45.');
        }
    ...
    public function setCustomAttribute1($custom_attribute1)
    {
        ...
        if ((mb_strlen($custom_attribute1) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute1 when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute2($custom_attribute2)
    {
        ...
        if ((mb_strlen($custom_attribute2) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute2 when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute3($custom_attribute3)
    {
        ...
        if ((mb_strlen($custom_attribute3) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute3 when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute4($custom_attribute4)
    {
        ...
        if ((mb_strlen($custom_attribute4) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute4 when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute5($custom_attribute5)
    {
        ...
        if ((mb_strlen($custom_attribute5) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute5 when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute6($custom_attribute6)
    {
        ...
        if ((mb_strlen($custom_attribute6) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute6 when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomAttribute7($custom_attribute7)
    {
        ...
        if ((mb_strlen($custom_attribute7) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute7 when calling BaseOrderHeaderDTO., must be smaller than or equal to 100.');
        }
