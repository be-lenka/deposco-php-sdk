...
/**
 * ItemVendorCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemVendorCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemVendorCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\ItemVendorDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling ItemVendorCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\ItemVendorDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\ItemVendorDTO[]|null $data data
     *
     * @return self
     */
