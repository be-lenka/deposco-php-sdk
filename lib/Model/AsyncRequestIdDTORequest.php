...
/**
 * AsyncRequestIdDTORequest Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class AsyncRequestIdDTORequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AsyncRequestIdDTO_request';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of the asynchronous request.
     *
     * @return self
     */
     ...
     * Sets href
     *
     * @param string|null $href Hyperlink to access the `GET` endpoint to retrieve the status of the asynchronous request.
     *
     * @return self
     */
