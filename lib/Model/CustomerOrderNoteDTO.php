...
/**
 * CustomerOrderNoteDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerOrderNoteDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerOrderNoteDTO';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/.*\\S.*/", $this->container['body'])) {
            $invalidProperties[] = "invalid value for 'body', must be conform to the pattern /.*\\S.*/.";
        }

        if (!is_null($this->container['source']) && (mb_strlen($this->container['source']) > 30)) {
            $invalidProperties[] = "invalid value for 'source', the character length must be smaller than or equal to 30.";
        }

        if (!is_null($this->container['priority']) && (mb_strlen($this->container['priority']) > 50)) {
            $invalidProperties[] = "invalid value for 'priority', the character length must be smaller than or equal to 50.";
        }
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 150)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CustomerOrderNoteDTO., must be smaller than or equal to 150.');
        }
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling CustomerOrderNoteDTO., must conform to the pattern /.*\\S.*/.");
        }
     ...
     * Sets body
     *
     * @param string $body Full text of the note.
     *
     * @return self
     */
    public function setBody($body)
    {
        ...
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($body)))) {
            throw new \InvalidArgumentException("invalid value for \$body when calling CustomerOrderNoteDTO., must conform to the pattern /.*\\S.*/.");
        }
     ...
     * Sets source
     *
     * @param string|null $source Source system from which the note was imported, if applicable. Typically set to the name of the external system or to a general value of `External`.
     *
     * @return self
     */
    public function setSource($source)
    {
        ...
        if (!is_null($source) && (mb_strlen($source) > 30)) {
            throw new \InvalidArgumentException('invalid length for $source when calling CustomerOrderNoteDTO., must be smaller than or equal to 30.');
        }
     ...
     * Sets priority
     *
     * @param string|null $priority Priority for the note.
     *
     * @return self
     */
    public function setPriority($priority)
    {
        ...
        if (!is_null($priority) && (mb_strlen($priority) > 50)) {
            throw new \InvalidArgumentException('invalid length for $priority when calling CustomerOrderNoteDTO., must be smaller than or equal to 50.');
        }
     ...
     * Sets created_date
     *
     * @param \DateTime|null $created_date Date and time that the note was created.
     *
     * @return self
     */
     ...
     * Sets updated_date
     *
     * @param \DateTime|null $updated_date Date and time that the note was last updated.
     *
     * @return self
     */
