 ...
 */
class NoteDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 150)) {
            throw new \InvalidArgumentException('invalid length for $title when calling NoteDTO., must be smaller than or equal to 150.');
        }
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling NoteDTO., must conform to the pattern /.*\\S.*/.");
        }
    ...
    public function setSource($source)
    {
        ...
        if (!is_null($source) && (mb_strlen($source) > 30)) {
            throw new \InvalidArgumentException('invalid length for $source when calling NoteDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setPriority($priority)
    {
        ...
        if ((mb_strlen($priority) > 50)) {
            throw new \InvalidArgumentException('invalid length for $priority when calling NoteDTO., must be smaller than or equal to 50.');
        }
