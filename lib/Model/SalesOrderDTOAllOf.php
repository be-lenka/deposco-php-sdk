...
/**
 * SalesOrderDTOAllOf Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class SalesOrderDTOAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesOrderDTO_allOf';
    ...
    */
    ...
    public function setDutyPaidByContactName($duty_paid_by_contact_name)
    {
        ...
        if (!is_null($duty_paid_by_contact_name) && (mb_strlen($duty_paid_by_contact_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $duty_paid_by_contact_name when calling SalesOrderDTOAllOf., must be smaller than or equal to 50.');
        }
    ...
    public function setDutyPaidByAccount($duty_paid_by_account)
    {
        ...
        if (!is_null($duty_paid_by_account) && (mb_strlen($duty_paid_by_account) > 50)) {
            throw new \InvalidArgumentException('invalid length for $duty_paid_by_account when calling SalesOrderDTOAllOf., must be smaller than or equal to 50.');
        }
    ...
    public function setDutyPaidByPostalCode($duty_paid_by_postal_code)
    {
        ...
        if (!is_null($duty_paid_by_postal_code) && (mb_strlen($duty_paid_by_postal_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $duty_paid_by_postal_code when calling SalesOrderDTOAllOf., must be smaller than or equal to 50.');
        }
    ...
    public function setDutyPaidByCountry($duty_paid_by_country)
    {
        ...
        if (!is_null($duty_paid_by_country) && (mb_strlen($duty_paid_by_country) > 50)) {
            throw new \InvalidArgumentException('invalid length for $duty_paid_by_country when calling SalesOrderDTOAllOf., must be smaller than or equal to 50.');
        }
