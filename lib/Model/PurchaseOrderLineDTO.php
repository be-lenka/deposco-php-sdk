    ...
    */
    ...
    public function setLineNumber($line_number)
    {
        ...
        if ((mb_strlen($line_number) > 55)) {
            throw new \InvalidArgumentException('invalid length for $line_number when calling PurchaseOrderLineDTO., must be smaller than or equal to 55.');
        }
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($line_number)))) {
            throw new \InvalidArgumentException("invalid value for \$line_number when calling PurchaseOrderLineDTO., must conform to the pattern /.*\\S.*/.");
        }
    ...
    public function setCustomerLineNumber($customer_line_number)
    {
        ...
        if ((mb_strlen($customer_line_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $customer_line_number when calling PurchaseOrderLineDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 250)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PurchaseOrderLineDTO., must be smaller than or equal to 250.');
        }
     ...
     *
     * @param int $order_pack_quantity Quantity of the item/pack that was ordered. Must be a positive value.
     *
     * @return self
     */
    public function setOrderPackQuantity($order_pack_quantity)
    {
        ...
        if (($order_pack_quantity > 483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $order_pack_quantity when calling PurchaseOrderLineDTO., must be smaller than or equal to 483344729602260992.');
        }
        if (($order_pack_quantity < -483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $order_pack_quantity when calling PurchaseOrderLineDTO., must be bigger than or equal to -483344729602260992.');
        }
    ...
    public function setCanceledPackQuantity($canceled_pack_quantity)
    {
        ...
        if (($canceled_pack_quantity > 483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $canceled_pack_quantity when calling PurchaseOrderLineDTO., must be smaller than or equal to 483344729602260992.');
        }
        if (($canceled_pack_quantity < -483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $canceled_pack_quantity when calling PurchaseOrderLineDTO., must be bigger than or equal to -483344729602260992.');
        }
    ...
    public function setLotNumber($lot_number)
    {
        ...
        if ((mb_strlen($lot_number) > 200)) {
            throw new \InvalidArgumentException('invalid length for $lot_number when calling PurchaseOrderLineDTO., must be smaller than or equal to 200.');
        }
    ...
    public function setProductCode($product_code)
    {
        ...
        if ((mb_strlen($product_code) > 40)) {
            throw new \InvalidArgumentException('invalid length for $product_code when calling PurchaseOrderLineDTO., must be smaller than or equal to 40.');
        }
    ...
    public function setInventoryCondition($inventory_condition)
    {
        ...
        if ((mb_strlen($inventory_condition) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_condition when calling PurchaseOrderLineDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setInventoryAttribute1($inventory_attribute1)
    {
        ...
        if ((mb_strlen($inventory_attribute1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_attribute1 when calling PurchaseOrderLineDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setInventoryAttribute2($inventory_attribute2)
    {
        ...
        if ((mb_strlen($inventory_attribute2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_attribute2 when calling PurchaseOrderLineDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setPriceCode($price_code)
    {
        ...
        if ((mb_strlen($price_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $price_code when calling PurchaseOrderLineDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setImportReference($import_reference)
    {
        ...
        if ((mb_strlen($import_reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $import_reference when calling PurchaseOrderLineDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setExportReference($export_reference)
    {
        ...
        if ((mb_strlen($export_reference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $export_reference when calling PurchaseOrderLineDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setCustomAttribute1($custom_attribute1)
    {
        ...
        if ((mb_strlen($custom_attribute1) > 400)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute1 when calling PurchaseOrderLineDTO., must be smaller than or equal to 400.');
        }
    ...
    public function setCustomAttribute2($custom_attribute2)
    {
        ...
        if ((mb_strlen($custom_attribute2) > 400)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute2 when calling PurchaseOrderLineDTO., must be smaller than or equal to 400.');
        }
    ...
    public function setCustomAttribute3($custom_attribute3)
    {
        ...
        if ((mb_strlen($custom_attribute3) > 400)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute3 when calling PurchaseOrderLineDTO., must be smaller than or equal to 400.');
        }
    ...
    public function setInboundLpn($inbound_lpn)
    {
        ...
        if (!is_null($inbound_lpn) && (mb_strlen($inbound_lpn) > 30)) {
            throw new \InvalidArgumentException('invalid length for $inbound_lpn when calling PurchaseOrderLineDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setMasterInboundLpn($master_inbound_lpn)
    {
        ...
        if (!is_null($master_inbound_lpn) && (mb_strlen($master_inbound_lpn) > 30)) {
            throw new \InvalidArgumentException('invalid length for $master_inbound_lpn when calling PurchaseOrderLineDTO., must be smaller than or equal to 30.');
        }
    ...
    public function setReceivedPackQuantity($received_pack_quantity)
    {
        ...
        if (($received_pack_quantity > 483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $received_pack_quantity when calling PurchaseOrderLineDTO., must be smaller than or equal to 483344729602260992.');
        }
        if (($received_pack_quantity < -483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $received_pack_quantity when calling PurchaseOrderLineDTO., must be bigger than or equal to -483344729602260992.');
        }
    ...
    public function setReceivedDamagedPackQuantity($received_damaged_pack_quantity)
    {
        ...
        if (($received_damaged_pack_quantity > 483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $received_damaged_pack_quantity when calling PurchaseOrderLineDTO., must be smaller than or equal to 483344729602260992.');
        }
        if (($received_damaged_pack_quantity < -483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $received_damaged_pack_quantity when calling PurchaseOrderLineDTO., must be bigger than or equal to -483344729602260992.');
        }
    ...
    public function setReturnedPackQuantity($returned_pack_quantity)
    {
        ...
        if (($returned_pack_quantity > 483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $returned_pack_quantity when calling PurchaseOrderLineDTO., must be smaller than or equal to 483344729602260992.');
        }
        if (($returned_pack_quantity < -483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $returned_pack_quantity when calling PurchaseOrderLineDTO., must be bigger than or equal to -483344729602260992.');
        }
    ...
    public function setInvoice($invoice)
    {
        ...
        if (!is_null($invoice) && (mb_strlen($invoice) > 50)) {
            throw new \InvalidArgumentException('invalid length for $invoice when calling PurchaseOrderLineDTO., must be smaller than or equal to 50.');
        }
