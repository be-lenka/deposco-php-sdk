<?php
/**
 * BaseOrderHeaderDTOShipToAddress
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * BaseOrderHeaderDTOShipToAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseOrderHeaderDTOShipToAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseOrderHeaderDTO_shipToAddress';
    ...
    */
    ...
    public function setLine1($line1)
    {
        ...
        if (!is_null($line1) && (mb_strlen($line1) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling BaseOrderHeaderDTOShipToAddress., must be smaller than or equal to 64.');
        }
    ...
    public function setLine2($line2)
    {
        ...
        if (!is_null($line2) && (mb_strlen($line2) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling BaseOrderHeaderDTOShipToAddress., must be smaller than or equal to 64.');
        }
    ...
    public function setLine3($line3)
    {
        ...
        if (!is_null($line3) && (mb_strlen($line3) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line3 when calling BaseOrderHeaderDTOShipToAddress., must be smaller than or equal to 64.');
        }
    ...
    public function setLine4($line4)
    {
        ...
        if (!is_null($line4) && (mb_strlen($line4) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line4 when calling BaseOrderHeaderDTOShipToAddress., must be smaller than or equal to 64.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling BaseOrderHeaderDTOShipToAddress., must be smaller than or equal to 30.');
        }
    ...
    public function setStateProvince($state_province)
    {
        ...
        if (!is_null($state_province) && (mb_strlen($state_province) > 100)) {
            throw new \InvalidArgumentException('invalid length for $state_province when calling BaseOrderHeaderDTOShipToAddress., must be smaller than or equal to 100.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling BaseOrderHeaderDTOShipToAddress., must be smaller than or equal to 20.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 100)) {
            throw new \InvalidArgumentException('invalid length for $country when calling BaseOrderHeaderDTOShipToAddress., must be smaller than or equal to 100.');
        }
