 ...
 */
class ItemUPCDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemUPCDTO';
    ...
    */
     ...
     * Sets value
     *
     * @param string $value UPC or barcode value.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling ItemUPCDTO., must conform to the pattern /.*\\S.*/.");
        }
