...
/**
 * CustomerReturnLineCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerReturnLineCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerReturnLineCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\CustomerReturnLineDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling CustomerReturnLineCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\CustomerReturnLineDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\CustomerReturnLineDTO[]|null $data data
     *
     * @return self
     */
