...
/**
 * ShippedContainerCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class ShippedContainerCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippedContainerCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\ShippedContainerDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling ShippedContainerCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\ShippedContainerDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\ShippedContainerDTO[]|null $data data
     *
     * @return self
     */
