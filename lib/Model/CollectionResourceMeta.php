...
/**
 * CollectionResourceMeta Class Doc Comment
 *
 * @category Class
 ...
 */
class CollectionResourceMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CollectionResourceMeta';
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling CollectionResourceMeta., must be bigger than or equal to 1.');
        }
