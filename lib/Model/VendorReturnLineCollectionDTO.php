...
/**
 * VendorReturnLineCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class VendorReturnLineCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VendorReturnLineCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\VendorReturnLineDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling VendorReturnLineCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\VendorReturnLineDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\VendorReturnLineDTO[]|null $data data
     *
     * @return self
     */
