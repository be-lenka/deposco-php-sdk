...
/**
 * SalesOrderLineCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class SalesOrderLineCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesOrderLineCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\SalesOrderLineDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling SalesOrderLineCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\SalesOrderLineDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\SalesOrderLineDTO[]|null $data data
     *
     * @return self
     */
