...
/**
 * BaseShipmentLineDTOPackDetails Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class BaseShipmentLineDTOPackDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseShipmentLineDTO_packDetails';
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $type when calling BaseShipmentLineDTOPackDetails., must be smaller than or equal to 50.');
        }
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($type)))) {
            throw new \InvalidArgumentException("invalid value for \$type when calling BaseShipmentLineDTOPackDetails., must conform to the pattern /.*\\S.*/.");
        }
