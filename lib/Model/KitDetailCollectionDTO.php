...
/**
 * KitDetailCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class KitDetailCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KitDetailCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\KitDetailDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling KitDetailCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\KitDetailDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\KitDetailDTO[]|null $data data
     *
     * @return self
     */
