...
/**
 * TradingPartnerParameterCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class TradingPartnerParameterCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TradingPartnerParameterCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\TradingPartnerParameterDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling TradingPartnerParameterCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\TradingPartnerParameterDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\TradingPartnerParameterDTO[]|null $data data
     *
     * @return self
     */
