...
/**
 * GetOutboundTransferOrders200Response Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class GetOutboundTransferOrders200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOutboundTransferOrders_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\OutboundTransferOrderCollectionDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling GetOutboundTransferOrders200Response., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\OutboundTransferOrderCollectionDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\OutboundTransferOrderCollectionDTO[]|null $data data
     *
     * @return self
     */
