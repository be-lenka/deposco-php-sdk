...
/**
 * KitDetailDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class KitDetailDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KitDetailDTO';
    ...
    protected static $openAPITypes = [
        ...
        'kit_header' => '\BeLenka\Deposco\Model\EntityRef',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('kit_header', $data ?? [], null);
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Whether the kit detail's item is created by the kit build (`Output`) or consumed in the kit build (`Input`).
     *
     * @return self
     */
     ...
     * @return \BeLenka\Deposco\Model\EntityRef|null
     */
    public function getKitHeader()
    {
        return $this->container['kit_header'];
    }

    /**
     * Sets kit_header
     *
     * @param \BeLenka\Deposco\Model\EntityRef|null $kit_header kit_header
     *
     * @return self
     */
    public function setKitHeader($kit_header)
    {
        if (is_null($kit_header)) {
            throw new \InvalidArgumentException('non-nullable kit_header cannot be null');
        }
        $this->container['kit_header'] = $kit_header;
     ...
     * Sets quantity
     *
     * @param int $quantity Quantity of the item that is required for the kit.
     *
     * @return self
     */
     ...
     * Sets rank
     *
     * @param int|null $rank Order of this kit detail in the build, if applicable.
     *
     * @return self
     */
     ...
     *
     * @param string|null $custom_attribute1 Custom field for the kit detail.
     *
     * @return self
     */
    public function setCustomAttribute1($custom_attribute1)
    {
        ...
        if ((mb_strlen($custom_attribute1) > 200)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute1 when calling KitDetailDTO., must be smaller than or equal to 200.');
        }
     ...
     *
     * @param string|null $custom_attribute2 Custom field for the kit detail.
     *
     * @return self
     */
    public function setCustomAttribute2($custom_attribute2)
    {
        ...
        if ((mb_strlen($custom_attribute2) > 200)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute2 when calling KitDetailDTO., must be smaller than or equal to 200.');
        }
     ...
     *
     * @param string|null $custom_attribute3 Custom field for the kit detail.
     *
     * @return self
     */
    public function setCustomAttribute3($custom_attribute3)
    {
        ...
        if ((mb_strlen($custom_attribute3) > 200)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute3 when calling KitDetailDTO., must be smaller than or equal to 200.');
        }
     ...
     * Sets created_date
     *
     * @param \DateTime|null $created_date Date and time that the kit detail was created.
     *
     * @return self
     */
     ...
     * Sets updated_date
     *
     * @param \DateTime|null $updated_date Date and time that the kit detail was last updated.
     *
     * @return self
     */
