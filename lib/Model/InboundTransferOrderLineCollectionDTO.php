...
/**
 * InboundTransferOrderLineCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class InboundTransferOrderLineCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InboundTransferOrderLineCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\InboundTransferOrderLineDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling InboundTransferOrderLineCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\InboundTransferOrderLineDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\InboundTransferOrderLineDTO[]|null $data data
     *
     * @return self
     */
