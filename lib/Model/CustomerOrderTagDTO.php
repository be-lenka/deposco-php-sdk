...
/**
 * CustomerOrderTagDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerOrderTagDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerOrderTagDTO';
    ...
    */
     ...
     * Sets tag
     *
     * @param string|null $tag Tag value for the customer order.
     *
     * @return self
     */
    public function setTag($tag)
    {
        ...
        if ((mb_strlen($tag) > 50)) {
            throw new \InvalidArgumentException('invalid length for $tag when calling CustomerOrderTagDTO., must be smaller than or equal to 50.');
        }
