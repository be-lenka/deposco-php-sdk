...
/**
 * ShippedContainerDTOWeight Class Doc Comment
 *
 * @category Class
 ...
 */
class ShippedContainerDTOWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippedContainerDTO_weight';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value > 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling ShippedContainerDTOWeight., must be smaller than or equal to 0.');
        }
        if (($value < 0)) {
