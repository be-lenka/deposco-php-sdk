...
/**
 * BaseShipmentLineDTO Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class BaseShipmentLineDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseShipmentLineDTO';
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $number when calling BaseShipmentLineDTO., must be smaller than or equal to 50.');
        }
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($number)))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling BaseShipmentLineDTO., must conform to the pattern /.*\\S.*/.");
        }
     ...
     * Sets description
     *
     * @param string|null $description Text that provides additional information about the shipment line.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BaseShipmentLineDTO., must be smaller than or equal to 500.');
        }
    ...
    public function setPackageCount($package_count)
    {
        ...
        if (($package_count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $package_count when calling BaseShipmentLineDTO., must be smaller than or equal to 2147483647.');
        }
        if (($package_count < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $package_count when calling BaseShipmentLineDTO., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setLotNumber($lot_number)
    {
        ...
        if ((mb_strlen($lot_number) > 200)) {
            throw new \InvalidArgumentException('invalid length for $lot_number when calling BaseShipmentLineDTO., must be smaller than or equal to 200.');
        }
    ...
    public function setInventoryCondition($inventory_condition)
    {
        ...
        if ((mb_strlen($inventory_condition) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_condition when calling BaseShipmentLineDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setInventoryAttribute1($inventory_attribute1)
    {
        ...
        if ((mb_strlen($inventory_attribute1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_attribute1 when calling BaseShipmentLineDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setInventoryAttribute2($inventory_attribute2)
    {
        ...
        if ((mb_strlen($inventory_attribute2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_attribute2 when calling BaseShipmentLineDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalLineNumber($external_line_number)
    {
        ...
        if ((mb_strlen($external_line_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $external_line_number when calling BaseShipmentLineDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setImportReference($import_reference)
    {
        ...
        if ((mb_strlen($import_reference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $import_reference when calling BaseShipmentLineDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setExportReference($export_reference)
    {
        ...
        if ((mb_strlen($export_reference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $export_reference when calling BaseShipmentLineDTO., must be smaller than or equal to 50.');
        }
