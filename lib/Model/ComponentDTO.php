...
/**
 * ComponentDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class ComponentDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ComponentDTO';
    ...
    protected static $openAPITypes = [
        ...
        'sub_component' => '\BeLenka\Deposco\Model\EntityRef',
        'sequence' => 'int',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sub_component', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sub_component'] === null) {
            $invalidProperties[] = "'sub_component' can't be null";
        }
     ...
     * Sets quantity
     *
     * @param int $quantity Quantity of the subcomponent that is required to make the item.
     *
     * @return self
     */
     ...
     * Sets sub_component
     *
     * @param \BeLenka\Deposco\Model\EntityRef $sub_component sub_component
     *
     * @return self
     */
    public function setSubComponent($sub_component)
    {
        if (is_null($sub_component)) {
            throw new \InvalidArgumentException('non-nullable sub_component cannot be null');
        }
     ...
     * Sets sequence
     *
     * @param int|null $sequence Numeric sequence for including the component item when the assembly or kit is built.
     *
     * @return self
     */
     ...
     * Sets created_date
     *
     * @param \DateTime|null $created_date Date and time that the component was created.
     *
     * @return self
     */
     ...
     * Sets updated_date
     *
     * @param \DateTime|null $updated_date Date and time that the component was last updated.
     *
     * @return self
     */
