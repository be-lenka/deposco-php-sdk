...
/**
 * BaseShipmentDTOOrderHeaders Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseShipmentDTOOrderHeaders implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseShipmentDTO_orderHeaders';
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling BaseShipmentDTOOrderHeaders., must be bigger than or equal to 1.');
        }
