...
class PurchaseOrderDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setOrderTotal($order_total)
    {
        ...
        if (($order_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_total when calling PurchaseOrderDTO., must be smaller than or equal to 0.');
        }
        if (($order_total < 0)) {
    ...
    public function setOrderSubtotal($order_subtotal)
    {
        ...
        if (($order_subtotal > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_subtotal when calling PurchaseOrderDTO., must be smaller than or equal to 0.');
        }
        if (($order_subtotal < 0)) {
    ...
    public function setOrderDiscountSubtotal($order_discount_subtotal)
    {
        ...
        if (($order_discount_subtotal > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_discount_subtotal when calling PurchaseOrderDTO., must be smaller than or equal to 0.');
        }
        if (($order_discount_subtotal < 0)) {
    ...
    public function setOrderShippingTotal($order_shipping_total)
    {
        ...
        if (($order_shipping_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_shipping_total when calling PurchaseOrderDTO., must be smaller than or equal to 0.');
        }
        if (($order_shipping_total < 0)) {
    ...
    public function setOrderShipTotal($order_ship_total)
    {
        ...
        if (($order_ship_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_ship_total when calling PurchaseOrderDTO., must be smaller than or equal to 0.');
        }
        if (($order_ship_total < 0)) {
    ...
    public function setOrderTaxTotal($order_tax_total)
    {
        ...
        if (($order_tax_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_tax_total when calling PurchaseOrderDTO., must be smaller than or equal to 0.');
        }
        if (($order_tax_total < 0)) {
    ...
    public function setOrderTaxableTotal($order_taxable_total)
    {
        ...
        if (($order_taxable_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_taxable_total when calling PurchaseOrderDTO., must be smaller than or equal to 0.');
        }
        if (($order_taxable_total < 0)) {
    ...
    public function setOrderUntaxableTotal($order_untaxable_total)
    {
        ...
        if (($order_untaxable_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $order_untaxable_total when calling PurchaseOrderDTO., must be smaller than or equal to 0.');
        }
        if (($order_untaxable_total < 0)) {
    ...
    public function setShippingTaxTotal($shipping_tax_total)
    {
        ...
        if (($shipping_tax_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_tax_total when calling PurchaseOrderDTO., must be smaller than or equal to 0.');
        }
        if (($shipping_tax_total < 0)) {
