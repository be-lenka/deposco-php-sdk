...
/**
 * StorageCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class StorageCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorageCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\StorageDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling StorageCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\StorageDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\StorageDTO[]|null $data data
     *
     * @return self
     */
