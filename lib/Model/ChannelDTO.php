 ...
 */
class ChannelDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelDTO';
    ...
    protected static $openAPITypes = [
        ...
        'scheduler_task' => '\BeLenka\Deposco\Model\ChannelDTOSchedulerTask',
        'ref1' => 'string',
        'ref2' => 'string',
        'ref3' => 'string',
        'ref4' => 'string',
    ...
    protected static $setters = [
        ...
        'scheduler_task' => 'setSchedulerTask',
        'ref1' => 'setRef1',
        'ref2' => 'setRef2',
        'ref3' => 'setRef3',
        'ref4' => 'setRef4',
    ...
    protected static $getters = [
        ...
        'scheduler_task' => 'getSchedulerTask',
        'ref1' => 'getRef1',
        'ref2' => 'getRef2',
        'ref3' => 'getRef3',
        'ref4' => 'getRef4',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('scheduler_task', $data ?? [], null);
    ...
    */
     ...
     * Gets scheduler_task
     *
     * @return \BeLenka\Deposco\Model\ChannelDTOSchedulerTask|null
     */
    public function getSchedulerTask()
    {
        return $this->container['scheduler_task'];
    }

    /**
     * Sets scheduler_task
     *
     * @param \BeLenka\Deposco\Model\ChannelDTOSchedulerTask|null $scheduler_task scheduler_task
     *
     * @return self
     */
    public function setSchedulerTask($scheduler_task)
    {
        if (is_null($scheduler_task)) {
            throw new \InvalidArgumentException('non-nullable scheduler_task cannot be null');
        }
        $this->container['scheduler_task'] = $scheduler_task;
     ...
     * Sets ref1
     *
     * @param string $ref1 Internal reference for the entity in the external system. This field should be set to the ID or number for the entity.
     *
     * @return self
     */
    public function setRef1($ref1)
    {
        ...
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($ref1)))) {
            throw new \InvalidArgumentException("invalid value for \$ref1 when calling ChannelDTO., must conform to the pattern /.*\\S.*/.");
        }
     ...
     * Sets ref2
     *
     * @param string|null $ref2 Internal reference for the entity in the external system.
     *
     * @return self
     */
     ...
     * Sets ref3
     *
     * @param string|null $ref3 Internal reference for the entity in the external system.
     *
     * @return self
     */
     ...
     * Sets ref4
     *
     * @param string|null $ref4 Internal reference for the entity in the external system.
     *
     * @return self
     */
     ...
     * Sets ref5
     *
     * @param string|null $ref5 Internal reference for the entity in the external system.
     *
     * @return self
     */
     ...
     * Sets sec_ref1
     *
     * @param string|null $sec_ref1 Secondary reference for the entity in the external system.
     *
     * @return self
     */
     ...
     * Sets sec_ref2
     *
     * @param string|null $sec_ref2 Secondary reference for the entity in the external system.
     *
     * @return self
     */
     ...
     * Sets sec_ref3
     *
     * @param string|null $sec_ref3 Secondary reference for the entity in the external system.
     *
     * @return self
     */
     ...
     * Sets sec_ref4
     *
     * @param string|null $sec_ref4 Secondary reference for the entity in the external system.
     *
     * @return self
     */
     ...
     * Sets sec_ref5
     *
     * @param string|null $sec_ref5 Secondary reference for the entity in the external system.
     *
     * @return self
     */
     ...
     * Sets created_date
     *
     * @param \DateTime|null $created_date Date and time that the channel cross-reference was created.
     *
     * @return self
     */
     ...
     * Sets updated_date
     *
     * @param \DateTime|null $updated_date Date and time that the channel cross-reference was last updated.
     *
     * @return self
     */
