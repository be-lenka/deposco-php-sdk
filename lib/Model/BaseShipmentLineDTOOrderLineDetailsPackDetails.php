<?php
/**
 * BaseShipmentLineDTOOrderLineDetailsPackDetails
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * BaseShipmentLineDTOOrderLineDetailsPackDetails Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class BaseShipmentLineDTOOrderLineDetailsPackDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseShipmentLineDTO_orderLineDetails_packDetails';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['type']) && !preg_match("/.*\\S.*/", $this->container['type'])) {
     ...
     * Sets type
     *
     * @param string|null $type Type of pack. Use one of the following values: `Each`, `Case`, `Bundle`, `Loose`, `Mill Unit`, `Outer`, `Unit`
     *
     * @return self
     */
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $type when calling BaseShipmentLineDTOOrderLineDetailsPackDetails., must be smaller than or equal to 50.');
        }
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($type)))) {
            throw new \InvalidArgumentException("invalid value for \$type when calling BaseShipmentLineDTOOrderLineDetailsPackDetails., must conform to the pattern /.*\\S.*/.");
        }
