...
/**
 * CustomerOrderLineSiteDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerOrderLineSiteDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerOrderLineSiteDTO';
    ...
    protected static $openAPITypes = [
        ...
        'number' => 'string',
        'trading_partner_site' => '\BeLenka\Deposco\Model\EntityRef',
        'order_quantity' => 'int',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trading_partner_site'] === null) {
            $invalidProperties[] = "'trading_partner_site' can't be null";
        }
     ...
     * Sets number
     *
     * @param string|null $number Unique number that identifies the order line site record.
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $number when calling CustomerOrderLineSiteDTO., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param \BeLenka\Deposco\Model\EntityRef $trading_partner_site trading_partner_site
     *
     * @return self
     */
    public function setTradingPartnerSite($trading_partner_site)
    {
        if (is_null($trading_partner_site)) {
            throw new \InvalidArgumentException('non-nullable trading_partner_site cannot be null');
        }
     ...
     * Sets order_quantity
     *
     * @param int $order_quantity Quantity of stock for the item that was ordered for the site.
     *
     * @return self
     */
     ...
     *
     * @param int|null $shipped_quantity Quantity of stock for the item that was shipped to the site.
     *
     * @return self
     */
     ...
     *
     * @param int|null $canceled_quantity Quantity of stock on the order line for the site that was canceled.
     *
     * @return self
     */
     ...
     *
     * @param int|null $returned_quantity Quantity of stock for the item that was returned from the site.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source Source system in which the order line site record originated.
     *
     * @return self
     */
    public function setSource($source)
    {
        ...
        if (!is_null($source) && (mb_strlen($source) > 255)) {
            throw new \InvalidArgumentException('invalid length for $source when calling CustomerOrderLineSiteDTO., must be smaller than or equal to 255.');
        }
     ...
     * Sets created_date
     *
     * @param \DateTime|null $created_date Date and time that the line site was created.
     *
     * @return self
     */
     ...
     * Sets updated_date
     *
     * @param \DateTime|null $updated_date Date and time that the line site was last updated.
     *
     * @return self
     */
