...
class CustomFieldDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['value']) && (mb_strlen($this->container['value']) > 300)) {
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomFieldDTO., must be smaller than or equal to 200.');
        }
     ...
     * Sets value
     *
     * @param string|null $value Value of the custom field.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 300)) {
            throw new \InvalidArgumentException('invalid length for $value when calling CustomFieldDTO., must be smaller than or equal to 300.');
        }
     ...
     * Sets type
     *
     * @param string|null $type Data type of the custom field.
     *
     * @return self
     */
     ...
     * Sets created_date
     *
     * @param \DateTime|null $created_date Date and time that the field value was created.
     *
     * @return self
     */
     ...
     * Sets updated_date
     *
     * @param \DateTime|null $updated_date Date and time that the field value was last updated.
     *
     * @return self
     */
