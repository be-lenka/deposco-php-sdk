...
/**
 * OutboundTransferOrderDTOAllOfShipments Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class OutboundTransferOrderDTOAllOfShipments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutboundTransferOrderDTO_allOf_shipments';
    ...
    protected static $openAPITypes = [
        'data' => '\BeLenka\Deposco\Model\EntityRef[]',
    ...
    */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\EntityRef[]|null $data data
     *
     * @return self
     */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling OutboundTransferOrderDTOAllOfShipments., must be bigger than or equal to 1.');
        }
