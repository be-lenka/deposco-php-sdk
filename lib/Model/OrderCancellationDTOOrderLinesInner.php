<?php
/**
 * OrderCancellationDTOOrderLinesInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OrderCancellationDTOOrderLinesInner Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class OrderCancellationDTOOrderLinesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCancellationDTO_orderLines_inner';
    ...
    */
     ...
     * Sets order_line
     *
     * @param \BeLenka\Deposco\Model\EntityRef $order_line order_line
     *
     * @return self
     */
     ...
     *
     * @param int|null $canceled_pack_quantity Quantity to cancel for the order line.
     *
     * @return self
     */
    public function setCanceledPackQuantity($canceled_pack_quantity)
    {
        ...
        if (($canceled_pack_quantity > -483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $canceled_pack_quantity when calling OrderCancellationDTOOrderLinesInner., must be smaller than or equal to -483344729602260992.');
        }
        if (($canceled_pack_quantity < 483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $canceled_pack_quantity when calling OrderCancellationDTOOrderLinesInner., must be bigger than or equal to 483344729602260992.');
        }
