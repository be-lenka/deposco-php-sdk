...
/**
 * GetOutboundTransferOrderLines200Response Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class GetOutboundTransferOrderLines200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOutboundTransferOrderLines_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\OutboundTransferOrderLineCollectionDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling GetOutboundTransferOrderLines200Response., must be bigger than or equal to 1.');
        }
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\OutboundTransferOrderLineCollectionDTO[]|null $data data
     *
     * @return self
     */
