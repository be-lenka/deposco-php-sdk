...
/**
 * FacilityDTOContact Class Doc Comment
 *
 * @category Class
 ...
 */
class FacilityDTOContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FacilityDTO_contact';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name First and last name of the contact person for the facility.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FacilityDTOContact., must be smaller than or equal to 30.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone Phone number of the contact person for the facility.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (mb_strlen($phone) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling FacilityDTOContact., must be smaller than or equal to 30.');
        }
     ...
     * Sets email
     *
     * @param string|null $email Email address of the contact person for the facility.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email when calling FacilityDTOContact., must be smaller than or equal to 50.');
        }
     ...
     * Sets fax
     *
     * @param string|null $fax Fax number of the contact person for the facility.
     *
     * @return self
     */
    public function setFax($fax)
    {
        ...
        if (!is_null($fax) && (mb_strlen($fax) > 50)) {
            throw new \InvalidArgumentException('invalid length for $fax when calling FacilityDTOContact., must be smaller than or equal to 50.');
        }
