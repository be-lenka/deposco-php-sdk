...
/**
 * BaseOrderLineDTO Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Deposco
 * @author   OpenAPI Generator team
 ...
 */
class BaseOrderLineDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseOrderLineDTO';
    ...
    */
    ...
    public function setLineNumber($line_number)
    {
        ...
        if ((mb_strlen($line_number) > 55)) {
            throw new \InvalidArgumentException('invalid length for $line_number when calling BaseOrderLineDTO., must be smaller than or equal to 55.');
        }
        if ((!preg_match("/.*\\S.*/", ObjectSerializer::toString($line_number)))) {
            throw new \InvalidArgumentException("invalid value for \$line_number when calling BaseOrderLineDTO., must conform to the pattern /.*\\S.*/.");
        }
    ...
    public function setCustomerLineNumber($customer_line_number)
    {
        ...
        if ((mb_strlen($customer_line_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $customer_line_number when calling BaseOrderLineDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 250)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BaseOrderLineDTO., must be smaller than or equal to 250.');
        }
    ...
    public function setOrderPackQuantity($order_pack_quantity)
    {
        ...
        if (($order_pack_quantity > -483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $order_pack_quantity when calling BaseOrderLineDTO., must be smaller than or equal to -483344729602260992.');
        }
        if (($order_pack_quantity < 483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $order_pack_quantity when calling BaseOrderLineDTO., must be bigger than or equal to 483344729602260992.');
        }
    ...
    public function setCanceledPackQuantity($canceled_pack_quantity)
    {
        ...
        if (($canceled_pack_quantity > -483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $canceled_pack_quantity when calling BaseOrderLineDTO., must be smaller than or equal to -483344729602260992.');
        }
        if (($canceled_pack_quantity < 483344729602260992)) {
            throw new \InvalidArgumentException('invalid value for $canceled_pack_quantity when calling BaseOrderLineDTO., must be bigger than or equal to 483344729602260992.');
        }
    ...
    public function setLotNumber($lot_number)
    {
        ...
        if ((mb_strlen($lot_number) > 200)) {
            throw new \InvalidArgumentException('invalid length for $lot_number when calling BaseOrderLineDTO., must be smaller than or equal to 200.');
        }
    ...
    public function setProductCode($product_code)
    {
        ...
        if ((mb_strlen($product_code) > 40)) {
            throw new \InvalidArgumentException('invalid length for $product_code when calling BaseOrderLineDTO., must be smaller than or equal to 40.');
        }
    ...
    public function setInventoryCondition($inventory_condition)
    {
        ...
        if ((mb_strlen($inventory_condition) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_condition when calling BaseOrderLineDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setInventoryAttribute1($inventory_attribute1)
    {
        ...
        if ((mb_strlen($inventory_attribute1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_attribute1 when calling BaseOrderLineDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setInventoryAttribute2($inventory_attribute2)
    {
        ...
        if ((mb_strlen($inventory_attribute2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_attribute2 when calling BaseOrderLineDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if (($unit_price > 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling BaseOrderLineDTO., must be smaller than or equal to 10000000.');
        }
        if (($unit_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling BaseOrderLineDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setUnitCost($unit_cost)
    {
        ...
        if (($unit_cost > 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_cost when calling BaseOrderLineDTO., must be smaller than or equal to 10000000.');
        }
        if (($unit_cost < 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_cost when calling BaseOrderLineDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setPriceCode($price_code)
    {
        ...
        if ((mb_strlen($price_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $price_code when calling BaseOrderLineDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setLineTotal($line_total)
    {
        ...
        if (($line_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $line_total when calling BaseOrderLineDTO., must be smaller than or equal to 10000000.');
        }
        if (($line_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $line_total when calling BaseOrderLineDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxCost($tax_cost)
    {
        ...
        if (($tax_cost > 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_cost when calling BaseOrderLineDTO., must be smaller than or equal to 10000000.');
        }
        if (($tax_cost < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_cost when calling BaseOrderLineDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxableTotal($taxable_total)
    {
        ...
        if (($taxable_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $taxable_total when calling BaseOrderLineDTO., must be smaller than or equal to 10000000.');
        }
        if (($taxable_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $taxable_total when calling BaseOrderLineDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setUntaxableTotal($untaxable_total)
    {
        ...
        if (($untaxable_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $untaxable_total when calling BaseOrderLineDTO., must be smaller than or equal to 10000000.');
        }
        if (($untaxable_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $untaxable_total when calling BaseOrderLineDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setExtendedTotal($extended_total)
    {
        ...
        if (($extended_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $extended_total when calling BaseOrderLineDTO., must be smaller than or equal to 10000000.');
        }
        if (($extended_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $extended_total when calling BaseOrderLineDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setDiscountAmount($discount_amount)
    {
        ...
        if (($discount_amount > 0)) {
            throw new \InvalidArgumentException('invalid value for $discount_amount when calling BaseOrderLineDTO., must be smaller than or equal to 10000000.');
        }
        if (($discount_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $discount_amount when calling BaseOrderLineDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setShippingAmount($shipping_amount)
    {
        ...
        if (($shipping_amount > 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_amount when calling BaseOrderLineDTO., must be smaller than or equal to 10000000.');
        }
        if (($shipping_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_amount when calling BaseOrderLineDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setImportReference($import_reference)
    {
        ...
        if ((mb_strlen($import_reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $import_reference when calling BaseOrderLineDTO., must be smaller than or equal to 100.');
        }
    ...
    public function setExportReference($export_reference)
    {
        ...
        if ((mb_strlen($export_reference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $export_reference when calling BaseOrderLineDTO., must be smaller than or equal to 50.');
        }
    ...
    public function setCustomAttribute1($custom_attribute1)
    {
        ...
        if ((mb_strlen($custom_attribute1) > 400)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute1 when calling BaseOrderLineDTO., must be smaller than or equal to 400.');
        }
    ...
    public function setCustomAttribute2($custom_attribute2)
    {
        ...
        if ((mb_strlen($custom_attribute2) > 400)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute2 when calling BaseOrderLineDTO., must be smaller than or equal to 400.');
        }
    ...
    public function setCustomAttribute3($custom_attribute3)
    {
        ...
        if ((mb_strlen($custom_attribute3) > 400)) {
            throw new \InvalidArgumentException('invalid length for $custom_attribute3 when calling BaseOrderLineDTO., must be smaller than or equal to 400.');
        }
