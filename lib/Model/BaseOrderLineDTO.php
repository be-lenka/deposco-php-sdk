...
class BaseOrderLineDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if (($unit_price > 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling BaseOrderLineDTO., must be smaller than or equal to 0.');
        }
        if (($unit_price < 0)) {
    ...
    public function setUnitCost($unit_cost)
    {
        ...
        if (($unit_cost > 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_cost when calling BaseOrderLineDTO., must be smaller than or equal to 0.');
        }
        if (($unit_cost < 0)) {
    ...
    public function setLineTotal($line_total)
    {
        ...
        if (($line_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $line_total when calling BaseOrderLineDTO., must be smaller than or equal to 0.');
        }
        if (($line_total < 0)) {
    ...
    public function setTaxCost($tax_cost)
    {
        ...
        if (($tax_cost > 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_cost when calling BaseOrderLineDTO., must be smaller than or equal to 0.');
        }
        if (($tax_cost < 0)) {
    ...
    public function setTaxableTotal($taxable_total)
    {
        ...
        if (($taxable_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $taxable_total when calling BaseOrderLineDTO., must be smaller than or equal to 0.');
        }
        if (($taxable_total < 0)) {
    ...
    public function setUntaxableTotal($untaxable_total)
    {
        ...
        if (($untaxable_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $untaxable_total when calling BaseOrderLineDTO., must be smaller than or equal to 0.');
        }
        if (($untaxable_total < 0)) {
    ...
    public function setExtendedTotal($extended_total)
    {
        ...
        if (($extended_total > 0)) {
            throw new \InvalidArgumentException('invalid value for $extended_total when calling BaseOrderLineDTO., must be smaller than or equal to 0.');
        }
        if (($extended_total < 0)) {
    ...
    public function setDiscountAmount($discount_amount)
    {
        ...
        if (($discount_amount > 0)) {
            throw new \InvalidArgumentException('invalid value for $discount_amount when calling BaseOrderLineDTO., must be smaller than or equal to 0.');
        }
        if (($discount_amount < 0)) {
    ...
    public function setShippingAmount($shipping_amount)
    {
        ...
        if (($shipping_amount > 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_amount when calling BaseOrderLineDTO., must be smaller than or equal to 0.');
        }
        if (($shipping_amount < 0)) {
