...
/**
 * BillableTransactionCollectionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class BillableTransactionCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillableTransactionCollectionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'pages' => 'int',
        'data' => '\BeLenka\Deposco\Model\BillableTransactionDTO[]'
    ];
    ...
    */
    ...
    public function setPages($pages)
    {
        ...
        if (!is_null($pages) && ($pages < 1)) {
            throw new \InvalidArgumentException('invalid value for $pages when calling BillableTransactionCollectionDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \BeLenka\Deposco\Model\BillableTransactionDTO[]|null
     */
     ...
     * Sets data
     *
     * @param \BeLenka\Deposco\Model\BillableTransactionDTO[]|null $data data
     *
     * @return self
     */
