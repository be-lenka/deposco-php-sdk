<?php
/**
 * BaseOrderHeaderDTOFreightBillToContact
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * BaseOrderHeaderDTOFreightBillToContact Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseOrderHeaderDTOFreightBillToContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseOrderHeaderDTO_freightBillToContact';
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling BaseOrderHeaderDTOFreightBillToContact., must be smaller than or equal to 30.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling BaseOrderHeaderDTOFreightBillToContact., must be smaller than or equal to 30.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (mb_strlen($phone) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling BaseOrderHeaderDTOFreightBillToContact., must be smaller than or equal to 30.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email when calling BaseOrderHeaderDTOFreightBillToContact., must be smaller than or equal to 50.');
        }
