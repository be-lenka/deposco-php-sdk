...
class ReceiptsApi
{
     ...
     *
     * @param  int $order_id ID of the related order header. (required)
     * @param  int $order_line_id ID of the related order line. (required)
     ...
     * @param  string $status Status of the receipt. (optional)
     * @param  string $lot_number Lot number of the receipt. (optional)
     * @param  string $serial_number Serial number of the receipt. (optional)
     ...
     * @return \BeLenka\Deposco\Model\ReceiptCollectionDTO|\BeLenka\Deposco\Model\BadRequestAPIResponse|\BeLenka\Deposco\Model\UnauthorizedAPIResponse|\BeLenka\Deposco\Model\ForbiddenAPIResponse|\BeLenka\Deposco\Model\RateLimitAPIResponse|\BeLenka\Deposco\Model\GetItemsDefaultResponse
     */
    public function getReceipts($order_id, $order_line_id, $business_unit = null, $created_after = null, $updated_after = null, $search_id = null, $page_size = 50, $status = null, $lot_number = null, $serial_number = null, string $contentType = self::contentTypes['getReceipts'][0])
    {
        list($response) = $this->getReceiptsWithHttpInfo($order_id, $order_line_id, $business_unit, $created_after, $updated_after, $search_id, $page_size, $status, $lot_number, $serial_number, $contentType);
        return $response;
    }
     ...
     * @throws \BeLenka\Deposco\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \BeLenka\Deposco\Model\ReceiptCollectionDTO|\BeLenka\Deposco\Model\BadRequestAPIResponse|\BeLenka\Deposco\Model\UnauthorizedAPIResponse|\BeLenka\Deposco\Model\ForbiddenAPIResponse|\BeLenka\Deposco\Model\RateLimitAPIResponse|\BeLenka\Deposco\Model\GetItemsDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReceiptsWithHttpInfo($order_id, $order_line_id, $business_unit = null, $created_after = null, $updated_after = null, $search_id = null, $page_size = 50, $status = null, $lot_number = null, $serial_number = null, string $contentType = self::contentTypes['getReceipts'][0])
    {
        $request = $this->getReceiptsRequest($order_id, $order_line_id, $business_unit, $created_after, $updated_after, $search_id, $page_size, $status, $lot_number, $serial_number, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\BeLenka\Deposco\Model\ReceiptCollectionDTO' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\BeLenka\Deposco\Model\ReceiptCollectionDTO' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\BeLenka\Deposco\Model\ReceiptCollectionDTO', []),
            ...
            $returnType = '\BeLenka\Deposco\Model\ReceiptCollectionDTO';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BeLenka\Deposco\Model\ReceiptCollectionDTO',
     ...
     */
    public function getReceiptsAsync($order_id, $order_line_id, $business_unit = null, $created_after = null, $updated_after = null, $search_id = null, $page_size = 50, $status = null, $lot_number = null, $serial_number = null, string $contentType = self::contentTypes['getReceipts'][0])
    {
        return $this->getReceiptsAsyncWithHttpInfo($order_id, $order_line_id, $business_unit, $created_after, $updated_after, $search_id, $page_size, $status, $lot_number, $serial_number, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReceiptsAsyncWithHttpInfo($order_id, $order_line_id, $business_unit = null, $created_after = null, $updated_after = null, $search_id = null, $page_size = 50, $status = null, $lot_number = null, $serial_number = null, string $contentType = self::contentTypes['getReceipts'][0])
    {
        $returnType = '\BeLenka\Deposco\Model\ReceiptCollectionDTO';
        $request = $this->getReceiptsRequest($order_id, $order_line_id, $business_unit, $created_after, $updated_after, $search_id, $page_size, $status, $lot_number, $serial_number, $contentType);
     ...
     */
    public function getReceiptsRequest($order_id, $order_line_id, $business_unit = null, $created_after = null, $updated_after = null, $search_id = null, $page_size = 50, $status = null, $lot_number = null, $serial_number = null, string $contentType = self::contentTypes['getReceipts'][0])
    {

        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling getReceipts'
            );
        }
        ...
        if ($order_line_id === null || (is_array($order_line_id) && count($order_line_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_line_id when calling getReceipts'
            );
        }
        ...
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ReceiptsApi.getReceipts, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ReceiptsApi.getReceipts, must be bigger than or equal to 1.');
        }
